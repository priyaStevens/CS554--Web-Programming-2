           ...
           unsplashImages: (pageNum) => {
            ...
            .then(json => {              
               json.map((element)=> {
                ...
                let image = {
                    id : element["id"] == null ? "NA" : element["id"],
                    url : imageUrl["regular"] === null ? "" : imageUrl["regular"],
                    description : element["description"] === null ? "NA" : element["description"],
                    posterName : user["name"] === null ? "NA" : user["name"],
                    userPosted : true,
                    binned : false
                 }
            ...
            console.log(`output = ${ImagePostArray.toString()}` )
